...
ExecStart=/bin/bash -c "source /home/user/.miniconda3/bin/activate jupyterlab && exec /home/user/.miniconda3/envs/jupyterlab/bin/jupyter lab"
Environment="PATH=/home/user/.miniconda3/envs/jupyterlab/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
